...
/*   Updated: 2022/05/01 15:06:13 by shogura          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	scan_signs(t_status **status, int *num, int *minus_sign)
{
	if (*num < 0)
	{
		(*status)->plus = -1;
...
void	print_sign(t_status **status, int minus_sign)
{
	if (minus_sign)
...
void	print_is_precision(t_status **status, int num, int minus_sign)
{
	if ((*status)->minus)
	{
		print_sign(status, minus_sign);
